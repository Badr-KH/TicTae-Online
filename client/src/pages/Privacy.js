  ...
  render() {
    return (
      <div>
        ...
        <p>
          tictaconline ("us", "we", or "our") operates the
          tictac-online.herokuapp.com website (hereinafter referred to as the
          "Service").
        </p>
        <p>
          ...
          tictaconline has been created with the help of{" "}
        ...
        <ul>
          <li>
            ...
            <p>
              Service is the tictac-online.herokuapp.com website operated by
              tictaconline
            </p>
          </li>
          <li>
        ...
        <h2>Use of Data</h2>
        <p>tictaconline uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          tictaconline will take all steps reasonably necessary to ensure that
        ...
        <p>
          tictaconline may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of tictaconline</li>
          <li>
        ...
        <ul>
          <li>By email: badrkhalfaoui96@gmail.com</li>
        </ul>{" "}
      </div>
    );
  }
